                ...
                <div className="modal-content" style={{ width: "500px" }} >
                    <form onSubmit={formik.handleSubmit}>
                        ...
                        <div className="modal-body ">
                            ...
                            <div className="col-lg-12">
                                <label htmlFor=""><h5>projects:</h5></label>

                                {/* <input type="text" name='name'value={formik.values.experience} onChange={formik.handleChange} className='form-control' /> */}
                            </div><br />
                            <div className="col-lg-12">
                                <label htmlFor="">projectName1</label>
                                <input type="text" name='projectName1' value={formik.values.projectName1} onChange={formik.handleChange} className='form-control' />
                            </div>
                            <div className="col-lg-12">
                                <label htmlFor="">projectDescription1</label>
                                <input type="text" name='projectDescription1' value={formik.values.projectDescription1} onChange={formik.handleChange} className='form-control' />
                            </div>
                            <div className="col-lg-12">
                                <label htmlFor="">projectLink1</label>
                                <input type="text" name='projectLink1' value={formik.values.projectLink1} onChange={formik.handleChange} className='form-control' />
                            </div>
                        </div>
