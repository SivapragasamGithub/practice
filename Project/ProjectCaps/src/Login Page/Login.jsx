                        ...
                        <div className="card border-0 shadow rounded-3 my-5">
                            <div className="card-body p-4 p-sm-5">
                                ...
                                <form>
                                    ...
                                    <div className="d-flex justify-content-center">
                                        <Link className="link-underline link-underline-opacity-0 link-underline-opacity-75-hover fw-bold mt-2 link-underline-primary border border-primary p-2" to="/Company-register">Employer Sign up</Link>
                                    </div>
                                    <div className="d-flex justify-content-center">
                                        <Link className="link-underline link-underline-opacity-0 link-underline-opacity-75-hover fw-bold m-3" to={"/reset-page"} >Reset Password</Link>
                                    </div>
